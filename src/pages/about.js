            ...
            <section className='wrap wrapper'>
                <div className={styles.content}>
                    ...
                    <div className={styles.about_img}>
                        ...
                        />
                        <p>Hi! <strong>i'm Isaac Chukwuka (aka Matrix)</strong>, i'm a <strong>self-taught Fullstack developer</strong> 💻, single, 20-something-year-old, with a strong educational background in <strong>Computer engineering</strong>. 
